    ...
    public function run(): void
    {
        ...
        foreach ($patientsData as $index => $data) {
            ...
            $patient = Patient::create([
                ...
                'rt_ktp' => '001',
                'rw_ktp' => '002',
                'kelurahan_ktp' => 'KELURAHAN MENTENG',
                'kecamatan_ktp' => 'KECAMATAN MENTENG',
                'kabupaten_ktp' => 'KOTA JAKARTA PUSAT',
                ...
                'rt_domisili' => '001',
                'rw_domisili' => '002',
                'kelurahan_domisili' => 'KELURAHAN MENTENG',
                'kecamatan_domisili' => 'KECAMATAN MENTENG',
                'kabupaten_domisili' => 'KOTA JAKARTA PUSAT',
