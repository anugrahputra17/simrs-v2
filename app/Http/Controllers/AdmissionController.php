...
class AdmissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'kelurahan_id_ktp' => 'required|integer',
            'kecamatan_id_ktp' => 'required|integer',
            'kabupaten_id_ktp' => 'required|integer',
            'provinsi_id_ktp' => 'required|integer',
            ...
            'kelurahan_id_domisili' => 'required|integer',
            'kecamatan_id_domisili' => 'required|integer',
            'kabupaten_id_domisili' => 'required|integer',
            'provinsi_id_domisili' => 'required|integer',
        ...
        try {
            $patientData = [
                ...
                'kabupaten_id_ktp' => $request->kabupaten_id_ktp,
                ...
                'kelurahan_id_domisili' => $request->kelurahan_id_domisili,
                'kecamatan_id_domisili' => $request->kecamatan_id_domisili,
                'kabupaten_id_domisili' => $request->kabupaten_id_domisili,
                'provinsi_id_domisili' => $request->provinsi_id_domisili,
